...
const Header = () => {
  return (
    <header className="border-b">
      <nav className="max-w-6xl py-4 mx-auto container flex  px-8 justify-between items-center">
        <div className="logo-container">
          ...
          >
            <g>
              ...
              ></path>
              <circle fill="#0086C3" cx="17.815" cy="11.516" r="4.402"></circle>
              <path
                fill="#0086C3"
              ...
              ></path>
              <circle fill="#0086C3" cx="17.801" cy="29.131" r="4.402"></circle>
              <g>
                <path
                  fill="#0086C3"
        ...
        <ul className="flex gap-4 ">
          <li className="nav-link">Why Plone</li>
          <li className="nav-link">Get Started</li>
          <li className="nav-link">Services</li>
          <li className="nav-link">Community</li>
          <li className="nav-link">Foundation</li>
          <li className="nav-link">News & Events</li>
        </ul>

        {/* other items */}
        <div className="flex  space-x-2 justify-between items-center">
          <button className="hover:text-primaryColor hover:font-bold transition-all duration-150">
            Try now
          </button>
          <button className=" border-l-2 border-slate-400 px-2">
            <SearchIcon />
          </button>
        </div>
      </nav>

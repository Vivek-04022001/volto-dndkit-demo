...
const Footer = () => {
  return (
    <section className="border-t-2 ">
      <footer className="max-w-6xl py-4 mx-auto container flex flex-col items-center px-8 ">
        <div className=" footer p-10 bg-neutral text-neutral- flex justify-between">
          <nav>
        ...
        <aside className="text-center flex items-center gap-3 ">
          <p>Copyright © 2024 - All right reserved by Plone</p>
